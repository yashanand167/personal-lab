  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden relative">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden relative flex flex-col">
        ...
        <div className="flex-1 max-w-4xl w-auto md:w-full mx-4 md:mx-auto border-x border-border/40 bg-background flex flex-col relative pb-0">
          ...
          <div className="xl:sticky xl:top-0 bg-background z-20">
            ...
            <div className="pt-4 sm:pt-6 pb-0 flex flex-col gap-4 sm:gap-6 relative">
          ...
          <main className="flex-1 bg-background flex flex-col">
            <div className="flex-1 grid grid-cols-2 md:grid-cols-3 border-dotted border-border bg-card/5 relative">
            {/* Vertical Dividers for Desktop */}
            <div className="hidden md:block absolute left-1/3 top-0 bottom-0 w-px border-r border-dotted border-border pointer-events-none" />
            <div className="hidden md:block absolute left-2/3 top-0 bottom-0 w-px border-r border-dotted border-border pointer-events-none" />
            {/* Vertical Divider for Mobile */}
            <div className="block md:hidden absolute left-1/2 top-0 bottom-0 w-px border-r border-dotted border-border pointer-events-none" />
            {/* Horizontal Divider for both Mobile and Desktop */}
            <div className="absolute left-0 right-0 top-1/2 w-full border-t border-dotted border-border pointer-events-none" />

            <div className="flex flex-col items-center justify-center gap-4 p-12 h-48 relative">
              <DottedLoading />
              <span className="text-[10px] uppercase tracking-wider text-muted-foreground font-mono">Dotted Grid</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-4 p-12 h-48 relative">
              <DottedCircleLoading />
              <span className="text-[10px] uppercase tracking-wider text-muted-foreground font-mono">Dotted Circle</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-4 p-12 h-48 relative">
              <DottedTrapezoid />
              <span className="text-[10px] uppercase tracking-wider text-muted-foreground font-mono">Dotted Trapezoid</span>
            </div>
            <div className="flex flex-col items-center justify-center gap-4 p-12 h-48 relative">
              <Inifinity />
              <span className="text-[10px] uppercase tracking-wider text-muted-foreground font-mono">Infinity</span>
            </div>
            </div>
          </main>
        </div>
